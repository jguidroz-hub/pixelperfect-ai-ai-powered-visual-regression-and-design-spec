  ...
  try {
    ...
    return new NextResponse(JSON.stringify(exportData, null, 2), {
      headers: {
        ...
        'Content-Disposition': `attachment; filename="PixelPerfect AI - AI-powered visual regression and design spec adherence for UI development-export-${new Date().toISOString().split('T')[0]}.json"`,
      },
    });
  } catch (error: any) {
