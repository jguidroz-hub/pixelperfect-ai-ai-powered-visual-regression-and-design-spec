  ...
  return (
    <div className="min-h-screen">
      ...
      <section className="max-w-4xl mx-auto px-6 py-20 text-center">
        <h1 className="text-4xl md:text-5xl font-bold mb-4">PixelPerfect AI - AI-powered visual regression and design spec adherence for UI development</h1>
        <p className="text-xl text-gray-600 mb-8 max-w-2xl mx-auto">Value Proposition: Automates Design QA for front-end developers and QA teams, visually comparing implemented UIs against design specs (e.g., Figma, Sketch). Reduces manual errors, speeds up QA cycles, and ensures pixel-perfect consistency and adherence to design systems across various devices.
...
Promotion Type: automatic</p>
      ...
      <section className="max-w-4xl mx-auto px-6 py-20 text-center">
        ...
        <p className="text-gray-600 mb-6">Join thousands of small businesses who trust PixelPerfect AI - AI-powered visual regression and design spec adherence for UI development.</p>
      ...
      <footer className="border-t py-8">
        <div className="max-w-4xl mx-auto px-6 flex justify-between text-sm text-gray-500">
          <p>© {new Date().getFullYear()} PixelPerfect AI - AI-powered visual regression and design spec adherence for UI development. All rights reserved.</p>
