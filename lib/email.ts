...
const FROM = process.env.EMAIL_FROM || 'PixelPerfect AI - AI-powered visual regression and design spec adherence for UI development <noreply@example.com>';
const APP_NAME = 'PixelPerfect AI - AI-powered visual regression and design spec adherence for UI development';
