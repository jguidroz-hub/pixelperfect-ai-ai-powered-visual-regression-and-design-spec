...
export default function FeaturePage() {
  const items = [
    { t: "Color Consistency: 89%", d: "4 unregistered colors found • 2 near-duplicates • Fix: merge to tokens", s: "warning" },
    { t: "Typography: 95% consistent", d: "12 font sizes in use • 2 outside design system • Body: 16px standard", s: "good" },
    { t: "Spacing: 82% consistent", d: "8px grid violations on 6 components • Padding inconsistencies flagged", s: "warning" },
    { t: "WCAG AA Compliance: 91%", d: "3 contrast failures • 2 missing aria-labels • 1 focus trap issue", s: "warning" }
  ];
  ...
  return (
    <div className="min-h-screen bg-gray-50">
      <header className="bg-white border-b px-6 py-3 flex items-center gap-4">
        ...
        <h1 className="font-bold">Design Audit</h1>
      </header>
      <div className="max-w-4xl mx-auto px-6 py-8">
        <p className="text-gray-500 text-sm mb-6">Check UI consistency and accessibility</p>
