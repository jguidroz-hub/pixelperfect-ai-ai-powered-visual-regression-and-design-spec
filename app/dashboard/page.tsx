...
export default function DashboardPage() {
  ...
  return (
    <div className="max-w-4xl mx-auto p-6">
      ...
      <p className="text-gray-600 mb-8">Here's your PixelPerfect AI - AI-powered visual regression and design spec adherence for UI development overview.</p>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-3 mb-8">
          <a href="/dashboard/design-specs" className="block p-4 border rounded-lg hover:bg-blue-50 transition">
            <h3 className="font-medium">Design Specifications</h3>
            <p className="text-sm text-gray-500">Manage and upload design references</p>
          </a>
          ...
          <a href="/run-test" className="block p-4 border rounded-lg hover:bg-blue-50 transition">
            ...
            <p className="text-sm text-gray-500">Initiate new visual comparison test</p>
          </a>
