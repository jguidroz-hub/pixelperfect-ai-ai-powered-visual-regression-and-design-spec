...
export default function RunTestPage() {
  const [items, setItems] = useState<RunTestItem[]>([]);
  ...
  const handleDelete = async (id: string) => {
    await fetch(`/api/run-test/${id}`, { method: 'DELETE' });
  ...
  return (
    <div className="max-w-4xl mx-auto p-6">
      <div className="flex items-center justify-between mb-6">
        <h1 className="text-2xl font-bold">Run Visual Test</h1>
        <button
      ...
      <p className="text-gray-600 mb-6">Initiate new visual comparison test</p>
